            ...
            while (runProgram)
            {
                ...
                switch (selection)
                {
                    ...
                    case ("Search for roommate"):
                        ...
                        Console.WriteLine($"Name: {roommate.FirstName} - Rent: {roommate.RentPortion} - Room: {roommate.Room.Name}");
                        Console.Write("Press any key to continue");
                        Console.ReadKey();
                        break;
                    ...
                    case ("Delete a room"):
                        List<Room> roomOptionsToDelete = roomRepo.GetAll();
                        foreach (Room r in roomOptionsToDelete)
                        {
                            Console.WriteLine($"{r.Id} - {r.Name} Max Occupancy({r.MaxOccupancy})");
                        }
                        ...
                        catch
                        {
                            ...
                            roomRepo.UpdateRoomId(selectedRoomIdToDelete, newId);
                            roomRepo.Delete(selectedRoomIdToDelete);
                        }
                        Console.Write("Press any key to continue");
                        Console.ReadKey();
